package com.hex.app.application.service;
...
/*
* Implementa la funcionalidad que se expone en el puerto de entrada
* y va a hacer uso del puerto de salida para poder mandar la informacion a
* cualquier lugar
 */
@Service
